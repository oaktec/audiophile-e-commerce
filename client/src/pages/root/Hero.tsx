...
const Hero = () => (
  <div className="h-[600px] w-full bg-dark-background sm:h-[729px]">
    <div className="container relative flex h-full w-full items-center justify-center overflow-hidden lg:justify-start">
      <div className="absolute inset-0 left-1/2 w-[750px] -translate-x-1/2 bg-tablet-header bg-contain bg-center bg-no-repeat opacity-50 lg:left-auto lg:translate-x-12 lg:opacity-100" />
